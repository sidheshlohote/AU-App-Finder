...
async function loadComparisonsFromBackend() {
    ...
    try {
        ...
        const response = await fetch(
            `/api/comparisons/${encodeURIComponent(user.id)}`
        );
...
async function loadFavoritesFromBackend() {
    ...
    try {
        ...
        const response = await fetch(
            `/api/favorites/${encodeURIComponent(user.id)}`
        );
...
async function toggleFavorite(toolId) {
    ...
    try {
        ...
        if (isFavorite) {
            ...
            const response =
                await fetch(
                    `/api/favorites/${encodeURIComponent(user.id)}/${encodeURIComponent(id)}`,
                    {
                        method: "DELETE"
                    }
                );
...
async function addToCompare(toolId) {
    ...
    try {
        ...
        if (isCompared) {
            ...
            const response =
                await fetch(
                    `/api/comparisons/${encodeURIComponent(user.id)}/${encodeURIComponent(id)}`,
                    {
                        method: "DELETE"
                    }
                );
